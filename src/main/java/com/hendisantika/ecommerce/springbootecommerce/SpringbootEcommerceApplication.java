...
public class SpringbootEcommerceApplication {
    ...
    CommandLineRunner runner(ProductService productService) {
        return args -> {
            productService.save(new Product("Samsung TV Set", 300.00, "https://encrypted-tbn0.gstatic" +
                    ".com/images?q=tbn:ANd9GcSHs_Q_HmDxOPprg7CJHWYf_qMf3qUtubTQ8nsSoC4FRdhsaT5ffg&s"));
            productService.save(new Product("Game Console", 200.00, "https://images-na.ssl-images-amazon" +
                    ".com/images/I/71jN27mYlhL._AC_SL1500_.jpg"));
            productService.save(new Product("Sofa", 100.00, "https://media.4rgos.it/i/Argos/9182723_R_Z001A?w=750" +
                    "&h=440&qlt=70"));
            productService.save(new Product("Ice Cream", 5.00, "https://mmc.tirto.id/image/otf/500x0/2020/03/31" +
                    "/header-walls-vienetta_ratio-16x9.jpg"));
            productService.save(new Product("Marjan", 3.00, "https://ecs7.tokopedia" +
                    ".net/img/cache/700/product-1/2018/10/18/4395737/4395737_869adbbe-e65e-4491-82eb" +
                    "-7f66cce49488_394_394.jpg"));
            productService.save(new Product("iPhone 16 Pro Max", 500.00, "https://www.concept-phones" +
                    ".com/wp-content/uploads/2019/08/iPhone-11X-concept-phone-Hasan-Kaymak-1.jpg"));
            productService.save(new Product("Watch", 30.00, "https://p.ipricegroup" +
                    ".com/uploaded_16689895db8e5bf4e35f115583693d64.jpg"));
            productService.save(new Product("MI TV Set", 300.00, "https://i01.appmifile" +
                    ".com/v1/MI_18455B3E4DA706226CF7535A58E875F0267/pms_1586239648.44731389.jpg"));
            productService.save(new Product("Brompton", 350.00, "https://www.brompton" +
